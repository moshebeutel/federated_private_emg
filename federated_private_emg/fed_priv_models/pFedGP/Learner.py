...
from federated_private_emg.fed_priv_models.pFedGP.tree import BinaryTreepFedGPFull, BinaryTreepFedGPIPData, \
    BinaryTreepFedGPIPCompute
from federated_private_emg.fed_priv_models.pFedGP.utils import CE_loss
...
class pFedGPFullLearner(Model):
    def __init__(self, n_output=2):
        super(pFedGPFullLearner, self).__init__()
    ...
    def build_base_tree(self, X, Y):
        ...
        self.tree = BinaryTreepFedGPFull(X.device)
