# Taken from https://github.com/IdanAchituve/pFedGP.git
# *****************************************************
import logging
...
class BinaryTreepFedGPFull(BinaryTree):
    def __init__(self, device):
        super(BinaryTreepFedGPFull, self).__init__(device)
    ...
    def build_tree(self, root, X, Y):
        ...
        while q:
            ...
            # Internal node
                ...
                gp_counter += 1
                root.set_model(Config.GP_KERNEL_FUNCTION,
                               Config.GP_NUM_GIBBS_STEPS_TRAIN,
                               Config.GP_NUM_GIBBS_DRAWS_TRAIN,
                               Config.GP_NUM_GIBBS_STEPS_TEST,
                               Config.GP_NUM_GIBBS_DRAWS_TEST,
                               Config.GP_OUTPUTSCALE_INCREASE,
                               Config.GP_OUTPUTSCALE,
                               Config.GP_LENGTHSCALE,
                               Config.GP_PREDICT_RATIO,
                               Config.GP_OBJECTIVE)
